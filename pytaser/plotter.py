        ...
        **kwargs,
        ...
        Args:
            ...
            yaxis: What spectral data to plot. If yaxis = "tas" (default), will plot the
                ...
                illumination.
                If yaxis = "alpha", will plot the effective absorption coefficient (a, including
                absorption and stimulated emission) before and after illumination.
                If yaxis = "das", will plot the difference between the optical absorption spectra
                of the new system and the reference system, together with the absorption spectra
                If yaxis = "jdos_das", will plot the difference between the JDOS of the new system
                and the reference system, together with the JDOS of both systems.
